...
class Order:
    def __init__(self, customer_name, tier, customer, items):
    ...
    def receipt(self):
        lines = []
        lines.append("Receipt for " + self.customer_name + " (" + self.tier + ")")
        lines.append("-" * 40)
...
def refactored_main():
    ...
    for name, tier, item_data in order_data:
        ...
        orders.append(Order(name, tier, customer, items))
